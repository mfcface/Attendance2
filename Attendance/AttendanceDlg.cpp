...
CAttendanceDlg::CAttendanceDlg(CWnd* pParent /*=nullptr*/)
	: CDialogEx(IDD_ATTENDANCE_DIALOG, pParent)
{
...
BEGIN_MESSAGE_MAP(CAttendanceDlg, CDialogEx)
	...
	ON_WM_PAINT()
	ON_WM_QUERYDRAGICON()
	ON_BN_CLICKED(IDC_BUTTON1, &CAttendanceDlg::OnBnClickedButton1)
END_MESSAGE_MAP()
...
void CAttendanceDlg::OnBnClickedButton1()
{
	// TODO: 在此添加控件通知处理程序代码
	if (true)
		MessageBox(_T("登录成功！！！"));
